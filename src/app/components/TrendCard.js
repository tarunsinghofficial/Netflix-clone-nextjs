...
function TrendCard({ title, rating, imgUrl, genre_1, genre_2, genre_3, description }) {
  ...
  return (
    <div
      className='w-60 h-[35em] rounded-md'
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
    >
      <Image src={imgUrl} alt="banner" className='w-60 h-96 rounded-md object-cover' width={1000} height={500} />
      {isHovered && (
        <div className="relative bottom-[24em] w-60 h-[30em] grid grid-rows-1/3  bg-[#141414] rounded-md overflow-hidden shadow-2xl shadow-black transition-transform duration-700 ease-in-out hover:scale-110">
          ...
          <div className='flex flex-col justify-between p-3 rounded-b-md'>
            ...
            <div className="flex flex-col items-start">
              <h3 className="text-sm font-bold text-white w-32">{title}</h3>

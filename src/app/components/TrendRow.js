...
function TrendRow({ title, fetchUrl, rowId }) {
  ...
  return (
    <>
      ...
      <div className='relative flex items-center group'>
        ...
        <div
          id={"slider" + rowId}
          className="flex flex-row overflow-x-auto overflow-y-hidden scroll-hide"
        >
          <div className="relative flex whitespace-normal gap-1 mt-[30px] -mb-[40px]">
